...
exports.practiceRoutes = (0, system_1.loadRoutes)([getQuestions_1.getQuestions, recordAnswer_1.recordAnswer], { prefix: '/practice' }, { historyTopicPractice: (fastify) => new history_1.HistoryTopicPractice(fastify) });
