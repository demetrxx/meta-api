...
exports.fondySubsCallback = void 0;
const console = __importStar(require("console"));
const payments_1 = require("@/modules/payments");
async function fondySubsCallback(fastify) {
    fastify.post((0, payments_1.subsCallbackPath)(), async (req, res) => {
...
exports.fondySubsCallback = fondySubsCallback;
